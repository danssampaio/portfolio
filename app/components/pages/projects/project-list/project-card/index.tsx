...
export const ProjectCard = ({ project }: ProjectProps) => {
  return (
    <div
     ...
     border-neutral-700 hover:border-[#1bc6c6] opacity-80 hover:opacity-100 transition-all group"
    >
      ...
      <div className="flex-1 flex flex-col p-4">
        <strong className="font-semibold text-neutral-50/90 group-hover:text-[#1bc6c6] transition-all">
          {project.title}
        </strong>
